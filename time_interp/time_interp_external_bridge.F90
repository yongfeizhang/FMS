...
module time_interp_external_bridge_mod
...
!</NAMELIST>
  ...
  use time_interp_external_mod, only: init_external_field, time_interp_external_init, get_external_field_size, get_time_axis
  use time_interp_external_mod, only: get_external_field_missing, set_override_region, reset_src_data_region, get_external_field_axes
  !use time_interp_external_mod, only: load_record, load_record_0d
...
!</IN>
    ...
    subroutine time_interp_external_bridge_3d(index1, index2, time, data, interp,verbose,horz_interp, mask_out, is_in, ie_in, js_in, je_in, window_id)
...
end module time_interp_external_bridge_mod
